...
\item
 { \color{red} Define two distributions $D_1, D_2$ and a function $f$ such that the expected value of $f$ on a draw from either distribution is equal. Define these such that you can get a large  lower bound on the probability below.}
