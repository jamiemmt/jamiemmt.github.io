...
\newcommand{\hmwkAssignedDate}{April 18}
\newcommand{\hmwkDueDate}{April 25, midnight}
...
{\bf Reminder: this homework is for extra credit! No late days.}
...
\item  Show that the variance of the estimate $A(q) = \frac{1}{d}(F_2 - x^2_q) \leq F_2/d.$
