...
|  1/10 <br> Wednesday     |  Course Policies, Procedures <br>  **Probability Basics** | <a href ="/teaching/s18-6550/_includes/notes-lec1-probability.pdf">  My notes</a>|
|    1/15 <br> Monday  (MLK Day) | No class | ||
|     1/17 <br> Wednesday  | CLASS CANCELLED || |
|     1/22 <br> Monday  |     Deterministic MST algorithms |<a href ="/teaching/s18-6550/_includes/notes-lec2-mst.pdf">  My notes</a> | | 
|  1/24 <br> Wednesday      | Randomized MSTs     |    ||
...
|  2/12 <br> Monday      |   Max-Weight Matchings in Graphs: A Pricing algorithm.   |    ||
...
|  3/26 <br> Monday      |   Concentration of Measure: "Chernoff-Hoeffding" Bounds.      |    ||| 
|  3/28 <br> Wednesday      | Dimension Reduction: JL and related topics | | |
|  4/2 <br> Monday      |   Streaming I: Computing Frequency Moments and JL    |    ||
|  4/4 <br> Wednesday      |  Dimension Reduction: Singular Value Decompositions      |    ||
|  4/9 <br> Monday      |  Online Algorithms: Rent-or-Buy and Paging, Online Primal-Dual  | | |
|    4/11 <br> Wednesday   |  Approximation Algorithms     |    ||
|   4/16 <br> Monday    | Matroids and Matroid Intersection     |    ||
|  4/18 <br> Wednesday |      Submodularity  <br>OR Fixed-Parameter Tractable Algorithms       <br> OR <br> Final Project Presentations | | |
