...
permalink: teaching/f18-fairml/policies.html
toc: true
---
...
1.  The cutoff for on-time submission is **11:59 PM** of the due date. Late
    days are counted in 24-hour periods.  We use the
    timestamp of your final git commit as the the time you submitted
    your assignment.

2.  You are given **2 "grace days"** (self-granted extensions) which you can
...
4.  Late work handed in when you have run out of grace counts for no
credit, but may be taken into account when tiebreaking between letter grades. 

5.   The final project must be submitted on time.

## Collaboration Policy

*Cribbed from writing by Julie Zelenski and  a
...
effort and not be derived from the thoughts and work of others.
...
forums, etc.) for information on course topics. The allowable
...
writing out solutions to hand in. 
