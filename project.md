...
The presentation of each project should take 10-15 minutes. The
presentation should cover:

* Motivation for the project
** If applicable, the particular context motivating the study
* Description of prior work in the space
** How this project fits in that space 
* What the project's main work was (e.g., modelling, experimental, theoretical)
* Describing  the result(s) of this work 
